...
// 	protoc        (unknown)
// source: bartering/v1/health.proto
...
func (ServingStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_bartering_v1_health_proto_enumTypes[0].Descriptor()
}

func (ServingStatus) Type() protoreflect.EnumType {
	return &file_bartering_v1_health_proto_enumTypes[0]
}
...
func (ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_bartering_v1_health_proto_rawDescGZIP(), []int{0}
}
...
func (x *CheckRequest) Reset() {
	*x = CheckRequest{}
	mi := &file_bartering_v1_health_proto_msgTypes[0]
...
func (x *CheckResponse) Reset() {
	*x = CheckResponse{}
	mi := &file_bartering_v1_health_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var (
	...
	file_bartering_v1_health_proto_rawDescData []byte
)

func file_bartering_v1_health_proto_rawDescGZIP() []byte {
	file_bartering_v1_health_proto_rawDescOnce.Do(func() {
		file_bartering_v1_health_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bartering_v1_health_proto_rawDesc), len(file_bartering_v1_health_proto_rawDesc)))
	})
	return file_bartering_v1_health_proto_rawDescData
}

var file_bartering_v1_health_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_bartering_v1_health_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_bartering_v1_health_proto_goTypes = []any{
	(ServingStatus)(0),    // 0: bartering.v1.ServingStatus
	(*CheckRequest)(nil),  // 1: bartering.v1.CheckRequest
...
func file_bartering_v1_health_proto_init() {
	if File_bartering_v1_health_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bartering_v1_health_proto_rawDesc), len(file_bartering_v1_health_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_bartering_v1_health_proto_goTypes,
		DependencyIndexes: file_bartering_v1_health_proto_depIdxs,
		EnumInfos:         file_bartering_v1_health_proto_enumTypes,
		MessageInfos:      file_bartering_v1_health_proto_msgTypes,
	}.Build()
	File_bartering_v1_health_proto = out.File
	file_bartering_v1_health_proto_goTypes = nil
	file_bartering_v1_health_proto_depIdxs = nil
}

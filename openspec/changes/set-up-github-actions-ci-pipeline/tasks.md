...
- [ ] 3.1 Push the branch and confirm all jobs appear in GitHub Actions and pass on a clean run
...
- [ ] 3.4 Verify the Docker image cache is populated after the first `test-go` run and used (not re-pulled) on a second run
